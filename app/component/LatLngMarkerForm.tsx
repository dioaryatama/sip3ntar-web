...
export default function LatLngMarkerForm({ onSubmit }: Props) {
  ...
  return (
    <div className="absolute top-4 left-14 z-[1000] w-80 sm:w-96 bg-white/95 backdrop-blur-sm shadow-2xl rounded-xl border border-white/50 transition-all animate-in fade-in slide-in-from-top-4 duration-300">
